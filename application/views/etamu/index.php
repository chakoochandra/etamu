<div class="card m-0">
	<h3 class="text-center p-2">eTAMU <?php echo strtoupper(SATKER_NAME) ?></h3>
		...
		<div class="container">
			<?php if ($message): ?>
				<div class="row justify-content-center">
					<div class="col-auto">
						<?php echo alert($message, 'Kelengkapan Data', ['class' => 'small alert-danger']) ?>
					</div>
				</div>
			<?php endif ?>
			<div class="row">
				<?php $showCamera = isset($form['photo']) ?>
				<?php if ($showCamera): ?>
					<div class="col-md-8 col-12 grid grid-a d-flex align-items-center">
						<!-- <h5 class="text-center">REKAM WAJAH</h5> -->
				...
				<?php endif ?>
				<div class="col-md-<?php echo ($showCamera ? 4 : 12) ?> col-12 grid grid-b">
					...
					<div class="p-2 d-flex align-items-center">
						<!-- <php echo '<label class="me-4" for="' . $form['gender']['name'] . '">' . $form['gender']['label'] . '</label>' ?> -->
					...
					<div class="p-2 d-flex flex-row">
						<button type="submit" class="col btn btn-outline-success m-1" style="min-width: 100px;"><i class="fa fa-save"></i> Simpan</button>
					</div>
				</div>
			</div>
		</div>
