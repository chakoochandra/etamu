...
<body>
	...
	$initPath = isset($options['init_path']) ? $options['init_path'] : ['', '/', ['canmodify' => true]];
	?>

	<script>
		var initPath = <?php echo json_encode($initPath) ?>;
	</script>
		...
		(function() {
			...
			var xhrparammap = {
				'file_explorer_refresh': {
					sec_t: '<?= BB_CreateSecurityToken("file_explorer_refresh") ?>'
				},
				'file_explorer_rename': {
					sec_t: '<?= BB_CreateSecurityToken("file_explorer_rename") ?>'
				},
				'file_explorer_file_info': {
					sec_t: '<?= BB_CreateSecurityToken("file_explorer_file_info") ?>'
				},
				'file_explorer_load_file': {
					sec_t: '<?= BB_CreateSecurityToken("file_explorer_load_file") ?>'
				},
				'file_explorer_save_file': {
					sec_t: '<?= BB_CreateSecurityToken("file_explorer_save_file") ?>'
				},
				'file_explorer_new_folder': {
					sec_t: '<?= BB_CreateSecurityToken("file_explorer_new_folder") ?>'
				},
				'file_explorer_new_file': {
					sec_t: '<?= BB_CreateSecurityToken("file_explorer_new_file") ?>'
				},
				'file_explorer_upload_init': {
					sec_t: '<?= BB_CreateSecurityToken("file_explorer_upload_init") ?>'
				},
				'file_explorer_upload': {
					sec_t: '<?= BB_CreateSecurityToken("file_explorer_upload") ?>'
				},
				'file_explorer_download': {
					sec_t: '<?= BB_CreateSecurityToken("file_explorer_download") ?>'
				},
				'file_explorer_copy_init': {
					sec_t: '<?= BB_CreateSecurityToken("file_explorer_copy_init") ?>'
				},
				'file_explorer_copy': {
					sec_t: '<?= BB_CreateSecurityToken("file_explorer_copy") ?>'
				},
				'file_explorer_move': {
					sec_t: '<?= BB_CreateSecurityToken("file_explorer_move") ?>'
				},
				'file_explorer_recycle': {
					sec_t: '<?= BB_CreateSecurityToken("file_explorer_recycle") ?>'
				},
				'file_explorer_delete': {
					sec_t: '<?= BB_CreateSecurityToken("file_explorer_delete") ?>'
				},
			};
