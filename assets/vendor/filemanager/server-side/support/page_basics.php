...
?>
	<div class="proptitlewrap">
		<div class="proptitle"><span id="navbutton"><span class="navbuttonline"></span><span class="navbuttonline"></span><span class="navbuttonline"></span></span><span class="proptitletext"><?php echo htmlspecialchars(BB_Translate($options["title"])); ?></span></div>
	</div>
	<?php
	...
	?>
		<div class="propmessagewrap propmessage<?php echo htmlspecialchars($_REQUEST["bb_msgtype"]); ?>">
			<div class="propmessage"><?php echo $data2; ?></div>
		</div>
	<?php
	}
	?>
	<div class="propdescwrap">
