          ...
          this.info() //get all video input devices info
            .then(webcams => {
              ...
              if ('zoom' in capabilities) {
                ...
                // Mendapatkan konstrain saat ini
                const constraints = track.getConstraints();

                // Mengatur zoom
                constraints.advanced = [{ zoom: 0.75 }];

                // Menerapkan konstrain baru
                track.applyConstraints({ advanced: constraints.advanced })
                  .then(function () {
